...
class BonusTier extends Model
{
     ...
     */
    public static function getBonusForSales(int $salesCount, ?int $userThreshold = null, ?float $userBonusAmount = null): float
    {
        ...
        if ($userBonusAmount !== null) {
            $bonusAmount = $userBonusAmount;
        } else {
