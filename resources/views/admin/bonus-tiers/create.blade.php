...
@section('title', 'Tambah Tier Bonus')
...
@section('content')
    ...
    <div class="card" style="max-width: 600px;">
        <div class="card-header">
            <h3 class="card-title">Tambah Tier Bonus Baru</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.bonus-tiers.store') }}" method="POST">
                @csrf
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="min_sales" id="min_sales" class="form-control"
                            value="{{ old('min_sales', 0) }}" min="0" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="bonus_amount" id="bonus_amount" class="form-control"
                        value="{{ old('bonus_amount', 0) }}" min="0" required>
                    @error('bonus_amount')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="description" id="description" class="form-control"
                        value="{{ old('description') }}" placeholder="Contoh: Bonus Bronze (20-49 pcs)">
                    @error('description')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
