    ...
    <nav class="sidebar-nav">
        @if(auth()->user()->isAdmin())
            ...
            <div class="nav-group">
                ...
                <a href="{{ route('admin.salary-records.index') }}"
                    class="nav-item {{ request()->routeIs('admin.salary-records.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="nav-group">
                ...
                <a href="{{ route('admin.salary-schemes.index') }}"
                    class="nav-item {{ request()->routeIs('admin.salary-schemes.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.bonus-tiers.index') }}"
                    class="nav-item {{ request()->routeIs('admin.bonus-tiers.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.tiktok-reports.index') }}"
                    class="nav-item {{ request()->routeIs('admin.tiktok-reports.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        @else
            ...
            <div class="nav-group">
                ...
                <a href="{{ route('user.attendances.create') }}"
                    class="nav-item {{ request()->routeIs('user.attendances.create') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('user.attendances.index') }}"
                    class="nav-item {{ request()->routeIs('user.attendances.index') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="sidebar-footer">
        <div class="flex items-center gap-3">
            ...
            <div class="flex-1 truncate">
                ...
                <div class="text-xs text-muted">{{ auth()->user()->task ?? auth()->user()->role }}</div>
            </div>
        </div>
    </div>
</aside>